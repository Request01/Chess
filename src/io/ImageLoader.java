...
public class ImageLoader {
    ...
    public static BufferedImage load (String URL) {
        ...
        try {
            ...
            if (input != null)
                ...
                System.err.println("Error at loading: " + path + "\t No so such resource found!");
        } catch (IOException e) {
            e.printStackTrace();
            System.err.println("Error at loading: " + path);
        }
        return image;
    }

    /**
     * Loads an Image as {@link javax.swing.ImageIcon}. Compare with {@link io.ImageLoader#load(String)}
     *
     ...
     * Compare with {@link io.ImageLoader#toBufferedImageNotContained(javax.swing.ImageIcon)}
     *
